...
def batched_decode_attention_mosaic(
    ...
    def kernel_body(
        ...
        def _compute_wg():
            ...
            row_ids = plgpu.layout_cast(jnp.arange(block_q, dtype=jnp.int32), plgpu.Layout.WGMMA)
            ...
            row_indices = plgpu.layout_cast(jnp.arange(block_q, dtype=jnp.int32), plgpu.Layout.WGMMA)
            ...
            def kv_loop(kv_step, carry):
                ...
                col_ids = plgpu.layout_cast(jnp.arange(block_kv, dtype=jnp.int32), plgpu.Layout.WGMMA)
...
def paged_decode_attention_mosaic_v2(
    ...
    def kernel(q_ref, k_cache_ref, v_cache_ref, block_tables_ref,
        ...
        def process_logical_block(logical_block_idx, carry):
            ...
            seq_indices = plgpu.layout_cast(jnp.arange(block_q), plgpu.Layout.WGMMA) + batch_start
            ...
            def process_kv_tile(kv_tile_idx, inner_carry):
                ...
                kv_positions = plgpu.layout_cast(jnp.arange(block_kv), plgpu.Layout.WGMMA) + block_start_pos + kv_pos_in_block
