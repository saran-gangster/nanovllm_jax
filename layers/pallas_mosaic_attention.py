...
def batched_decode_attention_mosaic(
    ...
    def kernel_body(
        ...
        def _compute_wg():
            ...
            # Use WG_SPLAT layout for 1D arrays (broadcast across warps)
            row_ids = plgpu.layout_cast(
                plgpu.broadcasted_iota(jnp.int32, (block_q,), 0),
            ...
            # Use WG_SPLAT layout for 1D arrays
            ...
            def kv_loop(kv_step, carry):
                ...
                col_ids = plgpu.layout_cast(
                    plgpu.broadcasted_iota(jnp.int32, (block_kv,), 0),
                    plgpu.Layout.WG_SPLAT
                )
