...
Internal tensor-parallel helpers remain in-tree for future work, but the
supported public runtime uses `tensor_parallel_size=1`.
"""
...
class Qwen3Attention(nnx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.mesh = mesh
        # Use bfloat16 for model computations - faster on modern GPUs (A100, A6000, etc.)
...
class Qwen3MLP(nnx.Module):
    ...
    Internal tensor-parallel helpers remain available, but the supported public
    runtime uses `tensor_parallel_size=1`.
    """
