"""Internal tensor-parallel utilities using JAX Mesh and shard_map.

This module provides explicit tensor-parallel primitives kept in-tree for
future multi-device work. The supported public runtime is still
